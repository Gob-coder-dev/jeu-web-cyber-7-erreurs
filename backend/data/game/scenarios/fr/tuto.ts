...
export const tuto: Scenario = {
    ...
    globalAttackScenario: "Bravo détective ! En situation réelle, un attaquant peut profiter d'informations vulnérables visibles sur des documents ou des post-it dans notre cas pour par exemple compromettre les systèmes d'informations d'une entreprise",
    questions: [
        {
            id: "règles-du-jeu",
