      ...
      hotspots: [
        {
          ...
          explanation:
            "Un transfert des mails de factures ou de paiements vers une adresse inconnue est extrêmement dangereux.",
        },
        {
          ...
          explanation:
            "Un transfert des mails vers une adresse inconnue dans les règles de messagerie est une trace forte de compromission.",
        },
        {
          ...
          explanation:
            "L'attaquant peut supprimer les alertes ou notifications pour masquer ses traces. De plus, ils sont marqué comme « lu » pour que l'utilisateur soit moins notifié de ces actions",
        },
      ],
    },
  ],
