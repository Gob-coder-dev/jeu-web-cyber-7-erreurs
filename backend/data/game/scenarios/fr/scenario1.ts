...
export const scenario1: Scenario = {
  ...
  "description": "L’entreprise Orialys a subi une intrusion. Des données comptables ont été volées et des virements suspects sur le compte de l’entreprise en direction de pays étrangers ont été détectés. Le service informatique ne comprend pas car aucun système de surveillance des comptes n’a identifié d’intrusion ou de virus.\n\nLa seule piste trouvée est que la dernière personne à avoir consulté les dossiers volés est Julien, le nouveau comptable de l’entreprise. Il nie pourtant toutes les accusations. L’entreprise pense donc que son compte a été piraté.",
  "difficulty": 1,
  "globalAttackScenario": "Mode opératoire probable : l’attaquant découvre la publication LinkedIn présentant Julien. La photo contient des informations sensibles : un mot de passe visible, le système d'exploitation et même des détails personnels (manga, football, rendez-vous médical). L'attaquant utilise ces informations pour préparer une intrusion physique et quelques jours plus tard pendant le rendez-vous médical de Julien, l'attaquant se présente à la porte de l'entreprise en prétendant être un fournisseur. Il repère le bureau de Julien grâce à la photo LinkedIn et déverrouille l'ordinateur avec le mot de passe écrit sur le post-it près du clavier. L'attaquant n’a même pas besoin de pirater l’ordinateur de la victime, il a tous les mots de passe affichés pour se connecter où il veut et récupérer toutes les informations confidentielles concernant l'entreprise sans laisser de traces.\n\nIl a aussi pu récupérer d’autres données plus facilement juste en récupérant la clé USB sur le bureau.",
  "goodPractices": "Avant de publier une photo professionnelle, vérifier qu’aucune information compromettante ne s’y trouve : mots de passe, habitudes d’employés, dates, outils informatiques de l’entreprise...\n\nAvant de quitter son poste, verrouiller sa session. Ne jamais afficher un mot de passe. Garder les documents, téléphones et équipements sensibles hors de portée de qui que ce soit.",
  "questions": [
    {
      ...
      "hotspots": [
        {
          ...
          "explanation": "Le post-it révèle un mot de passe en clair. Publié en ligne, tout le monde connaît le mot de passe de l’employé"
        },
        {
          ...
          "explanation": "Le post-it contient un rendez-vous médical. C'est une donnée personnelle qui ne devrait pas apparaître sur une publication."
        },
        {
        ...
        },
        {
          ...
          "explanation": "Une carte de jeu de football est visible sur le bureau. L'attaquant connaît donc des passions de l'employé, ce qui peut l'aider à créer une attaque de phishing ciblée."
        },
        {
      ...
      "hotspots": [
        {
          ...
          "explanation": "L'ordinateur est laissé allumé et connecté, ce qui peut permettre à un attaquant d'accéder aux informations sensibles si l'utilisateur s'éloigne de son poste de travail."
        },
        {
          ...
          "explanation": "Le mot de passe de l'utilisateur est écrit sur un post-it collé à côté de son ordinateur, ce qui peut permettre à un attaquant de le trouver facilement et d'accéder au compte de l'utilisateur."
        },
        {
          ...
          "explanation": "Une clé USB est posée sur le bureau sans surveillance ni sécurité. Elle peut se faire voler et des potentielles données sensibles sont donc en libre accès."
        }
      ]
    }
  ]
