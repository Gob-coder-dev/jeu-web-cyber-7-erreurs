    ...
    },
    {
      ...
      hotspots: [
        ...
        },
        {
          ...
          explanation:
            "If guests can download documents and share links, files can easily leave the company.",
        },
        {
    ...
    },
    {
      ...
      hotspots: [
        ...
        },
        {
          ...
          explanation:
            "The project name becomes sensitive if SharePoint is not strictly limited to the people concerned.",
        },
        {
          id: "edit-allowed",
          x: 1430,
        ...
        },
        {
          ...
          explanation:
            "If too many people can share the document, the attacker can spread access outside the intended group.",
        },
        {
    ...
    },
    {
      ...
      hotspots: [
        ...
        },
        {
          ...
          explanation:
            "The email asks the user to log in to view a document. This may be an attempt to steal credentials. The link points to an external or unknown website.",
        },
        {
          id: "urgent-tone",
          x: 720,
