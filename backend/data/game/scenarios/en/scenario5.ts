  ...
  questions: [
    {
      ...
      hotspots: [
        ...
        },
        {
          ...
          width: 0,
          height: 0,
          label: "Internal tools mentioned",
          explanation:
            "The job offer mentions tools, platforms, or methods used inside the company. This information can help an attacker make their message more credible.",
        },
        {
