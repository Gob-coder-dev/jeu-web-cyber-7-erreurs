...
export const scenario3: Scenario = {
  ...
  "goodPractices": "Any request for a transfer, bank details change, or urgent payment must be verified through an independent and official channel. Procedure bypasses must be refused, even when they seem to come from a manager.\n\nWhen in doubt, suspend the action, contact the person through a known number, warn a manager, and report the attempt.",
  "questions": [
    {
