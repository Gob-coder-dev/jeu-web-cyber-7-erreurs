      ...
      hotspots: [
        {
          ...
          width: 0,
          height: 0,
          label: "Automatic forwarding rule",
          explanation:
            "A forwarding rule can send a copy of emails to an address controlled by the attacker.",
        },
        {
          ...
          width: 0,
          height: 0,
          label: "Unknown external address",
          explanation:
            "An unknown address in mailbox rules is a strong sign of compromise.",
        },
        {
          ...
          width: 0,
          height: 0,
          label: "Automatic message deletion",
          explanation:
            "The attacker can delete alerts or notifications to hide their traces.",
        },
        {
          ...
          width: 0,
          height: 0,
          label: "Discreet rule name",
          explanation:
            "A rule named \"archive\", \"sync\", or \"backup\" can look normal while hiding a diversion.",
        },
        {
          ...
          width: 0,
          height: 0,
          label: "Settings not checked",
          explanation:
            "Users rarely check their mailbox rules. This allows the attacker to remain discreet.",
        },
        {
          ...
          width: 0,
          height: 0,
          label: "Messages read without visible action",
          explanation:
            "A compromised account can be spied on without the user immediately noticing any change.",
        },
      ],
    },
  ],
