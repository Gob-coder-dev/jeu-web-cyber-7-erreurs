...
export const scenario6: Scenario = {
  ...
  "goodPractices": "Never communicate a two-factor authentication code and never approve a login request that you did not initiate. When in doubt, contact support through a known official channel, never from a link or message you received.",
  "questions": [
    {
