...
export const scenario3: Scenario = {
  ...
  questions: [
      ...
      hotspots: [
        {
          ...
          explanation:
            "Les dates d'absence du directeur sont publiques. Un attaquant peut s'en servir pour savoir quand il sera difficilement joignable.",
        },
        {
        ...
        },
        {
          ...
          explanation:
            "Le post indique qui gère certains sujets pendant l'absence du directeur. Pour un attaquant, c'est une piste directe vers la bonne cible.",
        },
      ],
    },
    {
      ...
      instruction:
        "Comme la comptable dit avoir reçu un appel du directeur, vous regardez donc son historique d'appel pour voir la retranscription texte de l'appel. Elle affirme avoir reconnu le ton du directeur.",
      attackScenario:
        "L'appel ne contient pas de ligne de code, pas de virus, pas de lien malveillant. Et pourtant, il contient presque tout le mécanisme de l'attaque.\n\nL'attaquant utilise l'absence du directeur, l'urgence, la confidentialité et l'autorité hiérarchique. Il ne force pas le système : il pousse une personne à agir contre la procédure, en lui donnant l'impression d'aider son responsable.",
      ...
      hotspots: [
        {
          ...
          explanation:
            "Le supposé directeur explique qu'il appelle depuis l'étranger avec peu de réseau. Cela justifie un appel court et limite les possibilités de vérification.",
        },
        {
        ...
        },
        {
          ...
          explanation:
            "L'attaquant utilise l'autorité supposée du directeur pour réduire la capacité de la comptable à questionner la demande.\n\nL'attaquant veut savoir quand l'opération est terminée. Cela lui permet de suivre l'avancement de la fraude.",
        },
      ],
    },
    {
      ...
      instruction:
        "La comptable vous montre le mail qu'elle a reçu pendant l'appel. Le timing semble confirmer les paroles du directeur pendant l'appel.",
      attackScenario:
    ...
    },
    {
      ...
      instruction:
        "Après le virement, la comptable aurait reçu un dernier message dans sa boîte mail.",
      attackScenario:
