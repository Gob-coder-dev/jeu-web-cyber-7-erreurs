...
export const scenario1: Scenario = {
  ...
  description:
    "L'entreprise Orialys a subi une intrusion discrète. Des données comptables ont été volés et des virements suspects sur le compte de l'entreprise en direction de pays étrangers ont été détecté. Le servicee informatique ne comprend pas car aucun système de surveillance des comptes n'a identifié d'intrusion ou de virus.\n\nLa seule piste trouvée est que la dernière personne à avoir consulté les dossiers volés est Julien, le nouveau comptable de l'entreprise. Il nie pourtant toutes les accusations. L'entreprise pense donc que son compte a été piraté.",
  ...
  questions: [
    ...
    },
    {
      ...
      instruction:
        "Après avoir trouvé ce post problématique, vous retournez dans les locaux d'Orialyspour leur informer la situation. À l'entrée du bâtiment, vous croisez Julien en pause-café, et sur le chemin, vous passez devant son bureau. Vous jetez donc un œil sur son organisation de travail.",
      attackScenario:
